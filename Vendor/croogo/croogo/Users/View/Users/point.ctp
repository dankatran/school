<legend><i class="fa fa-list-ol"></i> Điểm thi của <?php echo $students['User']['name']; ?> - Lớp: <?php echo $points['Classroom']['name']; ?> - Năm học: <?php echo $points['Year']['name']?></legend>
<div role="tabpanel">
	<!-- Nav tabs -->
								...
								<tr>
									...
									<td>
										<?php 
											$number_mouth = 0;
											$total_mouth = 0;
											foreach ($user['Point'] as $key => $p) { 
										?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 1 && $p['semester'] == 1 && $p['classroom_id'] == $classid[0]){
									...
									<td>
										...
										?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 2 && $p['semester'] == 1 && $p['classroom_id'] == $classid[0]){
									...
									<td>
										...
										?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 3 && $p['semester'] == 1 && $p['classroom_id'] == $classid[0]){
									...
									<td>
										...
										?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 4 && $p['semester'] == 1 && $p['classroom_id'] == $classid[0]){
						...
						<tbody>
							<?php foreach ($subjects as $key => $sub) { ?>
								<tr>
									<td><?php echo $sub['Subject']['name']; ?></td>
									<td>
										<?php foreach ($user['Point'] as $key => $p) { ?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 1 && $p['semester'] == 2 && $p['classroom_id'] == $classid[0]){
													echo $p['point'];
												}
											?>
										<?php } ?>
									...
									<td>
										<?php foreach ($user['Point'] as $key => $p) { ?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 2 && $p['semester'] == 2 && $p['classroom_id'] == $classid[0]){
													echo $p['point'];
												}
											?>
										<?php } ?>
									...
									<td>
										<?php foreach ($user['Point'] as $key => $p) { ?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 3 && $p['semester'] == 2 && $p['classroom_id'] == $classid[0]){
													echo $p['point'];
												}
											?>
										<?php } ?>
									...
									<td>
										<?php foreach ($user['Point'] as $key => $p) { ?>
											<?php
												if($p['subject_id'] == $sub['Subject']['id'] && $p['type'] == 4 && $p['semester'] == 2 && $p['classroom_id'] == $classid[0]){
													echo $p['point'];
												}
											?>
										<?php } ?>
